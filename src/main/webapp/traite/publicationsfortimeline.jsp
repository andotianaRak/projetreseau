...
<%@page import="ando.mira.fevrandrana.entite.DetPartage"%>
...
<%
    ...
    List<DetPublication> listepubOfme = u.getAllPublications();
    List<DetPartage> listepartOfme = u.getAllPartages();

    JSONObject obj = null;
    JSONArray arr = new JSONArray();

    if (listdetpub.size() != 0 || listedetpart.size() != 0) {
        ...
        for (DetPublication ldp : listepubOfme) {
            try {
                obj = new JSONObject();
                obj.put("confidentialite", ldp.getConfidentialite());
                obj.put("contenupublication", ldp.getContenupublication());
        ...
        for (DetPartage ldp : listepartOfme) {
            try {
                obj = new JSONObject();
                obj.put("confidentialite", ldp.getConfidentialite());
                obj.put("contenupublication", ldp.getContenupublication());
